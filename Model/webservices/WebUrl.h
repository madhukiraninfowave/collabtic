...
#define PostThread (HeaderPath @"/forum/replypost")
...
#define ReplyImages (HeaderPath @"threadpost/threadupload_new")
...
#define ThreadDetails  (HeaderPath @"forum/getthreaddetails?")
#define postList (HeaderPath @"forum/postlist?")
